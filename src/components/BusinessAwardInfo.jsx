      ...
      <div className={`collapsed-gradient ${isExpanded ? 'full-text' : ''}`}>
        ...
        {isExpanded && (
          <div className="expanded-text">
            ...
            <p>
            Для участия в конкурсе, заявитель должен подать заявку через официальный сайт премии в период с 1 сентября по 15 октября 2024 года. Все заявки будут рассмотрены жюри, и финалисты в каждой номинации будут приглашены на торжественную церемонию награждения, которая состоится 1 декабря 2024 года.
            </p>
            <h3>5. Состав жюри</h3>
            <p>
