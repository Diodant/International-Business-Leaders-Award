  ...
  return (
    ...
    <div className="business-leaders-section">
        <div className="content-wrapper">
          ...
          <p>
С момента своего основания премия объединила более 5000 участников из таких стран, как Азербайджан, Армения, Беларусь, Казахстан, Кыргызстан, Молдова, Россия, Таджикистан, Туркменистан, США, Канада, Германия, ОАЭ, Узбекистан, Украина. Эта премия заслужила международное признание за строгие критерии отбора и высокие стандарты оценки участников, что подчеркивает ее исключительную значимость в мире бизнеса. Премия ежегодно привлекает внимание ведущих СМИ, бизнес-экспертов и общественных деятелей, укрепляя ее репутацию как одного из важнейших событий в деловом сообществе.
          </p>
          </div>
        </div>
      </div>
